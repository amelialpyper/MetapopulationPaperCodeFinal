functions {real switch_eta(real t, real t1, real eta, real mu, real xi) {
  ...
  real[] sir(real t, real[] y, real[] theta, 
      ...
      real xi2 = theta[14];
      real delta = theta[15]; //transport related infection rate for city 1 NOTE THAT IN THE WRITTEN WORK THIS VALUE IS REPRESENTED BY THE PARAMETER GAMMA
      real deltaY = theta[16]; //transport related infection rate for city 2 NOTE 
...
generated quantities {
  //real R0Y = betaY / (gammaY + sigmaY); 
  //real R0L = betaL / (gamma + sigma); //equation used to calculate R0, equation (43)
  //real ReffL[n_days];
  //real ReffY[n_days];
