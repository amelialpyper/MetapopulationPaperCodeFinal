...
IC = [s01,e01,i01,r01,d01,s02,e02,i02,r02,d02]; %initial conditions
...
ylabel({'Number of Individuals in each Compartment in Leeds'},'Color', 'black',FontSize =30, Interpreter='latex')
...
xlabel('Time, Days', FontSize=30); ylabel({'Number of Individuals in each Compartment in York'}, FontSize=30, Interpreter='latex')
xlim([0 123])
...
%exportgraphics(figure(1), 'seirdfullmeta_leeds_notrav.pdf','Resolution',300)
%exportgraphics(figure(2), 'seirdfullmeta_york_notrav.pdf','Resolution',300)
